  ...
  return (
    <section className="py-16 px-0 overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 mb-10 text-center">
        ...
        <h2 className="text-2xl font-bold">Mitra & Sponsor Kami</h2>
      </div>

      {/* Fade edges */}
      <div className="relative">
        <div className="absolute left-0 top-0 h-full w-24 z-10 pointer-events-none bg-gradient-to-r from-background to-transparent" />
        <div className="absolute right-0 top-0 h-full w-24 z-10 pointer-events-none bg-gradient-to-l from-background to-transparent" />
        ...
        <div className="overflow-hidden cursor-pointer">
          <div ref={trackRef} className="flex gap-6 w-max">
            {ALL.map((sponsor, i) => (
              <div
                key={i}
                className="flex-shrink-0 w-48 h-24 rounded-2xl border border-border bg-background shadow-sm flex flex-col items-center justify-center gap-1 hover:shadow-md hover:border-primary/30 transition-all duration-300 px-4"
              >
