...
const WA_LINK = "https://chat.whatsapp.com/your-group-invite-link" // ← ganti dengan link grup WhatsApp kamu
  ...
  return (
    <>
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 px-4 pb-4 pt-2
                      bg-gradient-to-t from-background/95 to-background/0 pointer-events-none">
